...
export default function MitraKonsinyasiIndex({ partners, filters }) {
    ...
    function submit(e) {
        ...
        if (editing) {
            put(route('mitra-konsinyasi.update', editing.id), options);
        } else {
            post(route('mitra-konsinyasi.store'), options);
        }
    }
    ...
    function destroy(partner) {
        ...
        router.delete(route('mitra-konsinyasi.destroy', partner.id), {
            preserveScroll: true,
        });
    }
        ...
        >
            ...
            <div className="py-6">
                <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
                    ...
                    {partners.links && partners.data.length > 0 && (
